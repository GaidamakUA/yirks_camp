...
func save_level(file_name: String, save_data: Dictionary):
	_save_data_to_file(save_data, SAVE_DIR, str(file_name, FILE_SUFFIX))

func load_level(file_name: String):
	var real_file_name = str(file_name, FILE_SUFFIX)
	var save_data = _load_data_from_file(SAVE_DIR, real_file_name)
